...
import com.zengzp.product.entity.*;
...
/**
 * @author ：zengzhipeng
 * @date ：Created in 2022/11/10 17:10
 * @description：token访问类
 * @modified By：
 * @version: 1$
 */
@Slf4j
...
public class TokenController {
    ...
    public UserToken userToken(String username, String password) {
        // 根据用户名查询密码, 并比较密码(密码可以RSA加密一下)
        UserToken userInfo = new UserToken(username, "81255cb0dca1a5f304328a70ac85dcbd", "111111");
    ...
    private AccessToken saveToken(int tokenType, AppInfo appInfo,  UserToken userInfo) {
